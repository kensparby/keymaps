...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        KC_LEFT, KC_LCTL, KC_LGUI, KC_LALT,MO(SYMB),   LALT_T(KC_APP),            KC_ENT,         MO(MOVE), KC_LBRC, KC_RBRC, KC_RGUI, KC_RGHT,
                                             KC_SPC,  KC_BSPC, KC_ENT,           CAPS_WORD,MO(MDIA),MO(SYMB)
    ),
    ...
    [APPS] = LAYOUT_moonlander(
       ...
       KC_CAPS, XXXXXXX, XXXXXXX,LAG(KC_S), XXXXXXX, XXXXXXX, XXXXXXX,           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX,           XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                            XXXXXXX, XXXXXXX, XXXXXXX,           XXXXXXX, XXXXXXX, XXXXXXX
    ),
