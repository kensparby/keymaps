...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYMB] = LAYOUT_moonlander(
       TG(SYMB),   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5, _______,           _______,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
    ...
    [MOVE] = LAYOUT_moonlander(
       TG(MOVE), _______, _______, _______, _______, _______, _______,           _______, _______, KC_ACL0, KC_ACL1, KC_ACL2, _______, _______,
        ...
        _______,   TURBO, _______, _______, _______, KC_BTN1,                             KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC, XXXXXXX, XXXXXXX,
    ...
    [MDIA] = LAYOUT_moonlander(
       TG(MDIA), _______, _______, _______, _______, _______, _______,           _______, _______, _______, _______, _______, _______, _______,
